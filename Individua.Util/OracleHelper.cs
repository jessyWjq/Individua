...
namespace Individua.Util
{
    ...
    public sealed class OracleHelper
    {
        ...
        static readonly string connectionString = ConfigurationManager.ConnectionStrings["jtjs"].ConnectionString;
        ...
        public static OracleDataReader ExecuteReader(string commandText)
        {
            ...
            {
                conn.Open();
                return ExecuteReader(conn, (OracleTransaction)null, CommandType.Text, commandText, null, OracleConnectionOwnership.External);
            }
            catch
            {
                conn.Close();
        ...
        public static OracleDataReader ExecuteReader(string commandText, params OracleParameter[] commandParameters)
        {
            ...
            {
                conn.Open();
                return ExecuteReader(conn, (OracleTransaction)null, CommandType.Text, commandText, commandParameters, OracleConnectionOwnership.Internal);
            }
            catch
            {
                conn.Close();
