...
namespace Individua.Util.ImageHelps
{
    public static class ImageHelps
    {
        /// <summary>
        /// 图片压缩
        /// </summary>
        /// <param name="originalImagePath">原文件路径</param>
        /// <param name="thumbnailPath">压缩后文件</param>
        ...
        public static void MakeThumbnail(string originalImagePath, string thumbnailPath, int width, int height)
        {
            ...
            //第一个Rectangle是原图片的画布坐标和宽高,第二个是原图片写在画布上的坐标和宽高,最后一个参数是指定数值单位为像素 
