...
namespace SZXFZ.Web.Models
{
    ...
    public class SessionHelper
    {
        ...
        public static UserEntity GetCurrentUser()
        {
            ...
            {
                if (HttpContext.Current.Session["CurrentUser"] is UserEntity)
                {
                    return HttpContext.Current.Session["CurrentUser"] as UserEntity;
                }
                else
                {
                    return null;
        ...
        public static void AddCurrentUser(UserEntity user)
        {
